  ...
  <div class="mt-20 flex justify-between gap-10">
    ...
    <div class="mr-2 flex-3">
          ...
          <ol class="flex h-8 space-x-2 text-gray-800">
            ...
            <li class="flex items-center space-x-1">
              ...
              <a
                rel="noopener noreferrer"
                href="#"
                class="flex cursor-default items-center px-1 capitalize hover:no-underline"
                >Current</a
              >
            </li>
          </ol>
          ...
          <fieldset class="w-full space-y-1 text-gray-800">
            ...
            <div class="relative">
              ...
              <input
                ...
                name="Search"
                placeholder="Search..."
                class="w-32 rounded-md bg-gray-100 py-2 pl-10 text-sm text-gray-800 focus:border-emerald-600 focus:bg-gray-50 focus:outline-none sm:w-auto"
              />
            </div>
          </fieldset>
        </div>
      ...
      <div
        ...
        class="mt-5 grid max-h-[70vh] grid-cols-1 gap-5 overflow-y-auto pr-2 pb-2 md:grid-cols-2 lg:grid-cols-3 lg:justify-items-center"
      >
        <ProductCard
  ...
  for (let key of filterKeys) {
    ...
    list = list.filter((p) => {
      if (typeof p[key] === "string" || typeof p[key] === "number") {
        return (
          selectedArr.includes(String(p[key])) || selectedArr.includes(p[key])
        );
      }
